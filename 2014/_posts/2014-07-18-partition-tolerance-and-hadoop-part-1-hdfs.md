...
![HDFS Architecture]({% asset png-transparent.png @path %}){:class="lazyload" data-src="{% asset 2014-07-18-partition-tolerance-and-hadoop-part-1-hdfs/partition-tolerance-and-hadoop-part-1-hdfs.gif @path %}" width="{{ assets["2014-07-18-partition-tolerance-and-hadoop-part-1-hdfs/partition-tolerance-and-hadoop-part-1-hdfs.gif"].dimensions.width }}" height="{{ assets["2014-07-18-partition-tolerance-and-hadoop-part-1-hdfs/partition-tolerance-and-hadoop-part-1-hdfs.gif"].dimensions.height }}"}
